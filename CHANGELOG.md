...
* reduce code analysis warnings (#343)
* remove VSSdk package (#331)
* use DotNetDev.ArcadeLight.Sdk V1.7.0 (#315)
...
* Bump xunit.extensibility.execution and xunit.extensibility.core (#337) @dependabot
* Bump xunit.runner.console from 2.6.6 to 2.7.0 (#340) @dependabot
* Bump coverlet.collector from 6.0.1-preview.41.g16b9883710 to 6.0.1-preview.43.g52ddde6e8d (#335) @dependabot
* Bump System.Text.Json from 8.0.1 to 8.0.2 (#334) @dependabot
* Bump NuGet.Versioning from 6.8.0 to 6.9.1 (#333) @dependabot
* Bump coverlet.collector from 6.0.1-preview.40.g50fbaa7bb9 to 6.0.1-preview.41.g16b9883710 (#332) @dependabot
* Bump coverlet.collector from 6.0.1-preview.39.g9321d2e2cc to 6.0.1-preview.40.g50fbaa7bb9 (#330) @dependabot
* Bump Microsoft.NET.StringTools from 17.7.2 to 17.9.5 (#327) @dependabot
* Bump dotnet-reportgenerator-globaltool from 5.2.0 to 5.2.1 (#324) @dependabot
* Bump Microsoft.NET.Test.Sdk, Microsoft.TestPlatform.TestHost and Microsoft.TestPlatform.ObjectModel (#325) @dependabot
* Bump coverlet.collector from 6.0.1-preview.36.g9295fca754 to 6.0.1-preview.39.g9321d2e2cc (#323) @dependabot
* Bump xunit.runner.console from 2.6.5 to 2.6.6 (#321) @dependabot
